...
function FormatEditor(parent,format,id,showFont) {
  ...
  var s='<div id="'+id+'" width="130">   <ul>     <li><a href="#ftabs-1">Fill</a></li>     <li><a href="#ftabs-2">Stroke</a></li>';

  if (showFont)
    s+='<li><a href="#ftabs-3">Font</a></li>';

  s+='<li><a href="#ftabs-4">Gradient</a></li>       <li><a href="#ftabs-5">Shadow</a></li>       <li><a href="#ftabs-6">Image</a></li>   </ul>   <div id="ftabs-1">         Fill:         <input type="text" size="16" id="'+id+'ffill">           <div id="color_box">             <div id="'+id+'color_display" style="position: relative; left: 5px; width: 15px; height: 15px; cursor: pointer; border: 2px solid #000;">             </div>             <div id="'+id+'color_picker" style="display:none"></div>           </div>         </BR>         Transparency %:         <div id="ftransp" style="width=150px;"></div>   </div>   <div id="ftabs-2">         Stroke:         <input type="text" size="16" id="'+id+'fstroke">         <div id="'+id+'fstrokesize"></div>';

  if (showFont)
    s+='Horiz Round:</br><div id="'+id+'fstrokeroundx"></div>         Vert Round:</br><div id="'+id+'fstrokeroundy"></div>';

    s+='Join:         <select id="'+id+'fstroke_join">           <option value="round">Round</option>           <option value="miter">Miter</option>           <option value="bevel">Bevel</option>         </select>         Cap:         <select id="'+id+'fstroke_cap">           <option value="round">Round</option>           <option value="butt">Butt</option>           <option value="square">Square</option>         </select>   </div>';

  if (showFont)
    s+='<div id="ftabs-3" style="display:'+showFont+'">         <input type="text" size="46" id="'+id+'ffontstyle">         <div id="'+id+'ffontsize"></div>         <div id="'+id+'ffontformat"></div>         </div>';

  s+='<div id="ftabs-4">         <input type="checkbox" id="'+id+'fgradient" checked>Visible         Direction:</br>         <select id="'+id+'fgradient_direction">           <option value="topbottom">Top Bottom</option>           <option value="leftright">Left Right</option>           <option value="bottomtop" selected>Bottom Top</option>           <option value="rightleft">Right Left</option>           <option value="radial">Radial</option>           <option value="diagonalup">Diagonal Up</option>           <option value="diagonaldown">Diagonal Down</option>         </select>         Balance:         <div id="'+id+'fgradient_balance" style="width=150px;"></div>   </div>   <div id="ftabs-5">         <input type="checkbox" id="'+id+'fshadow">Visible</br>         Color:         <input type="text" size="16" id="'+id+'fshadowcolor">         <span>Width:</span>&nbsp;&nbsp;<div id="'+id+'fshadow_width" style="width=150px;"></div>         <span>Height:</span>&nbsp;&nbsp;<div id="'+id+'fshadow_height" style="width=150px;"></div>         <span>Blur:</span>&nbsp;&nbsp;<div id="'+id+'fshadow_blur" style="width=150px;"></div>   </div>   <div id="ftabs-6">   </div>   </div>';
...
function AxisEditor(parent,axis,id) {
  ...
  var s='<div id="'+id+'" width="130">   <ul>     <li><a href="#atabs-1">Axis</a></li>     <li><a href="#atabs-2">Labels</a></li>     <li><a href="#atabs-3">Grid</a></li>     <li><a href="#atabs-4">Ticks</a></li>   </ul>   <div id="atabs-1">     <input type="checkbox" id="'+id+'_visible">Visible     <input type="checkbox" id="'+id+'_inverted">Inverted     <input type="checkbox" id="'+id+'_auto">Automatic   </div>   <div id="atabs-2">     <input type="checkbox" id="'+id+'labels_visible">Visible     <div id="'+id+'labels-format"></div>   </div>   <div id="atabs-3">     <input type="checkbox" id="'+id+'grid_visible">Visible     <div id="'+id+'grid-format"></div>   </div>   <div id="atabs-4">     <input type="checkbox" id="'+id+'ticks_visible">Visible         Color:         <input type="text" size="16" id="'+id+'ticksstroke">         <div id="'+id+'tickslength"></div>         <div id="'+id+'tickssize"></div>         Join:         <select id="'+id+'ticks_join">           <option value="round">Round</option>           <option value="miter">Miter</option>           <option value="bevel">Bevel</option>         </select>         Cap:         <select id="'+id+'ticks_cap">           <option value="round">Round</option>           <option value="butt">Butt</option>           <option value="square">Square</option>         </select>   </div>   </div>';
...
function ChartEditor(parent,chart) {
  ...
  parent.innerHTML='<div id="tabs" width="130">   <ul>     <li><a href="#tabs-1">Series</a></li>     <li><a href="#tabs-2">Axes</a></li>     <li><a href="#tabs-3">Panel</a></li>     <li><a href="#tabs-4">Walls</a></li>     <li><a href="#tabs-5">Legend</a></li>     <li><a href="#tabs-6">Aspect</a></li>     <li><a href="#tabs-7">Titles</a></li>     <li><a href="#tabs-8">Touch</a></li>   </ul>   <div id="tabs-1">         <div style="float:left; width:20%;">         <select size="5" style="width:100px; height:20%">'+seriesItems()+'</select>         </div>         <div id="seriestabs" style="float:right; width:70%;">           <ul>             <li><a href="#series-formattab">Format</a></li>             <li><a href="#series-marks">Marks</a></li>             <li><a href="#series-general">General</a></li>           </ul>           <div id="series-formattab">             <input type="checkbox" id="series_visible">Visible             Color Each:             <select id="series_coloreach">               <option value="auto">Automatic</option>               <option value="yes">Yes</option>               <option value="no">No</option>             </select>             </br>Transparency %:             <div id="series_transp" style="width=150px;"></div></br>             <div id="series-format"></div>           </div>           <div id="series-marks">             <input type="checkbox" id="series_marks">Marks             <div id="series-marks-format"></div>           </div>           <div id="series-general">             Mouse Cursor:</br>             <select id="series_cursor" onchange="chart.series.items[0].cursor= document.getElementById(\'series_cursor\').value;">               <option value="default">Default</option>               <option value="pointer">Pointer</option>               <option value="crosshair">Crosshair</option>             </select>             </br>           </div>         </div>   </div>   <div id="tabs-2">         <input type="checkbox" id="axes_visible">Visible         </BR>         <div id="axistabs" width="130">           <ul>             <li><a href="#axis-left">Left</a></li>             <li><a href="#axis-bottom">Bottom</a></li>             <li><a href="#axis-right">Right</a></li>             <li><a href="#axis-top">Top</a></li>           </ul>           <div id="axis-left"></div>           <div id="axis-bottom"></div>           <div id="axis-right"></div>           <div id="axis-top"></div>         </div>   </div>   <div id="tabs-3">         <div id="panel-format"></div>         <input type="checkbox" id="panel_transp">Transparent         </br>         Bottom margin %:         <div id="margin_bottom" style="width:50px; float: left;"></div>         Left margin %:         <div id="margin_left" style="width:50px; float: left;"></div>            </div>   <div id="tabs-4">         <input type="checkbox" id="walls_visible">Visible</BR>         <div id="backwall-format"></div>        </div>   <div id="tabs-5">         <div style="float:left; width:20%;">           <input type="checkbox" id="legend_visible">Visible           <input type="checkbox" id="legend_inverted">Inverted</BR>           Legend style:</br>           <select id="legend_style">             <option value="auto">Auto</option>             <option value="series">Series</option>             <option value="values">Values</option>           </select>           </br>           Text style:</br>           <select id="legend_textstyle">             <option value="auto" selected>Auto</option>             <option value="valuelabel">Value and Label</option>             <option value="label">Label</option>             <option value="value">Value</option>             <option value="index">Index</option>             <option value="labelvalue">Label and Value</option>             <option value="percent">Percent</option>             <option value="percentlabel">Percent and Label</option>           </select>           </br>           Position:</br>           <select id="legend_position">             <option value="right">Right</option>             <option value="left">Left</option>             <option value="top">Top</option>             <option value="bottom">Bottom</option>           </select>           </br>           Padding:</br>           <div id="legend_padding"></div>           </br>           Vertical:</br>           <div id="legend_vertical"></div>           <input type="checkbox" id="legend_symbols">Symbols         </div>         <div id="legend-format" style="float:right;">         </div>   </div>   <div id="tabs-6">         <input type="checkbox" id="clip">Clip   </div>   <div id="tabs-7">         Title:         <input type="text" size="46" id="title_text">         <input type="checkbox" id="title_transp" checked>Transparent         <div id="title-format"></div>         </br>         Footer:         <input type="text" size="46" id="footer_text">         <input type="checkbox" id="footer_transp" checked>Transparent         <div id="footer-format"></div>   </div>   <div id="tabs-8">   </div> </div>';
